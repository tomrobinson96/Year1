...
{
    /// <summary>
    /// Represents a compact disc (CD) style title
    /// </summary>
    class CompactDisc : Title
    {
        /// <summary>
        /// Identifier for use in saved data.
        /// </summary>
        public const string TypeName = "CD";
        ...
        public CompactDisc(string artist, string title, float price)
        ...
        public CompactDisc(string sourceData)
        {
        ...
        /// <summary>
        /// Writes the state of this object to a Stream in a fixed format.
        /// </summary>
