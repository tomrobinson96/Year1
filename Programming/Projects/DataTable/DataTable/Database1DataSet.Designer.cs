...
namespace DataTable {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class studentsDataTable : global::System.Data.TypedTableBase<studentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentsRow AddstudentsRow(int Id, string student_name) {
...
namespace DataTable.Database1DataSetTableAdapters {
    ...
    public partial class studentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[students] ([Id], [student name]) VALUES (@Id, @student_name);\r" +
                "\nSELECT Id, [student name] FROM students WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[students] SET [Id] = @Id, [student name] = @student_name WHERE (([I" +
                "d] = @Original_Id));\r\nSELECT Id, [student name] FROM students WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::DataTable.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, [student name] FROM dbo.students";
        ...
        public virtual int Insert(int Id, string student_name) {
        ...
        public virtual int Update(int Id, string student_name, int Original_Id) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string student_name, int Original_Id) {
            return this.Update(Original_Id, student_name, Original_Id);
        }
    }
